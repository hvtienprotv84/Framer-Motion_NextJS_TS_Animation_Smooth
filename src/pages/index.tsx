...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Tiến - Framer Motion - NextJS</title>
        <meta
          name="description"
      ...
      >
        ...
        >
          ...
          <AnimatedText element="h1" text="Tôi là" />
          <AnimatedText element="h1" className="text-[2em]" text="Huỳnh Vĩnh Tiến" />
          ...
          <Image src={Logo} alt="logo" className="mt-[80px] lg:hidden " width={500}/>
